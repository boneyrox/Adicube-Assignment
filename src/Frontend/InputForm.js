...
const InputForm = () => {
    ...
    return (
        <div action='/' className="input__form">
            ...
            <div className="input__box">
                <input className="form_box" onChange={(e)=>setEmail(e.target.value)} name="email" type="text" placeholder="Office E-mail address"/>
            </div>
            <div className="input__box">
            ...
            <div className="input__box">
                <input className="formbox" onChange={(e)=>setLoginId(e.target.value)} name="loginId" type="text" placeholder="Login ID"/>
